...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray text-sm">
       ...
       <main class="container mx-auto flex max-w-custom">
           <div class="w-70 mr-5">
               <b> ADD IDEA FORMS GOES HERE!</b> Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe quia corrupti adipisci laudantium alias modi in quaerat, laboriosam sed, vel, mollitia numquam quasi velit laborum. Aspernatur sapiente aperiam dolore nisi ex soluta impedit exercitationem consequuntur, delectus, reprehenderit, beatae vel repellendus?
           </div>
           <div class="w-175">
